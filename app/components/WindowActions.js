...
function WindowActions(props) {
  ...
  return (
    <Grid container justify="space-between">
      ...
      <Grid item>
        <ButtonBase
          className={classNames(classes.windowButtonBase, classes.minMaxButton)}
          onClick={minimize}
        >
          <MinimizeIcon />
        </ButtonBase>
        ...
        <ButtonBase
          className={classNames(classes.windowButtonBase, classes.closeButton)}
          onClick={close}
        >
          <CloseIcon />
        </ButtonBase>
...
export default withStyles(styles)(WindowActions);
